...
<head>
  <title>Oferta dla właścicieli obiektów noclegowych - Dodaj obiekt</title>

  <meta name="description" content="Tysiące osób każdego dnia poszukuje noclegu na Noclegowo. Zacznij docierać do nich już dziś. Wybierz rozliczenie za rezerwacje lub opłatę abonamentową.">
...
<body>
  ...
  <div id="wrapper">
        ...
        <div id="header" class="container-fluid"><a class="navbar-brand js-scroll-trigger" href="#"> <img src="/img/noclegowo.svg" /></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><span class="nav-link popup">+48 794 944 944</span></li>
            ...
            <div class="row h-100 align-items-center">
              <div class="col-lg-5 col-md-8">
                <div class="form_body text-center signin">
                  <a name="dodaj">
                    <h2 class="form_title">Oferujesz noclegi? Zacznij pozyskiwać gości już dziś!</h2>
                  </a>
                  <small class="text-muted">Jeśli potrzebujesz skutecznej reklamy swojego obiektu, to jesteś w dobrym miejscu! Dodaj ofertę w kilka minut. </small>
                  <form action="<?=$_SERVER['REQUEST_URI']?>" method="post" class="ng-pristine ng-valid " siq_id="autopick_9090">
                    ...
                    <label class="form-check" for="regulation">
                      <span class="checkmark"></span><span>Oświadczam, że znam i akceptuję <a target="_blank" href="https://oldpanel.noclegowo.pl/info/regulamin">regulamin
                          serwisu</a>.</span>
                    </label>
                    <span>
    ...
    <section class="about">
      <div class="container">
        <div class="section_title">
          <h1>Dlaczego Noclegowo?</h1>
          <p class="text-muted">Wynajmujesz noclegi? Prowadzisz wynajem krótkoterminowy? <br>Nasza oferta jest dla Ciebie!</p>
        </div>
        <div class="row">
          <div class="col-md-4">
    ...
    <section class="category">
      <div class="section_title">
        <h1>Czy Noclegowo jest dla mnie?</h1>
        <p class="text-muted">Oczywiście. Na pewno. Bez dwóch zdań.</p>
      </div>
              ...
              <div class="container">
                <div class="row justify-content-center">
                  ...
                  <div class="col-md-4">
                    <div class="category_single">
                      <div class="category_avatar">
                        <img src="img/category/agroturism.webp" alt="">
                      </div>
                      <div class="category_caption">
                  ...
                  <div class="col-md-4">
                    <div class="category_single">
                      <div class="category_avatar">
                        <img src="img/category/rooms.webp" alt="">
                      </div>
                      <div class="category_caption">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-4">
                    <div class="category_single">
                      <div class="category_avatar">
                        <img src="img/category/camping.webp" alt="">
                      </div>
                      <div class="category_caption">
                  ...
                  <div class="col-md-4">
                    <div class="category_single">
                      <div class="category_avatar">
                        <img src="img/category/holiday_house.webp" alt="">
                      </div>
                      <div class="category_caption">
                  ...
                  <div class="col-md-4">
                    <div class="category_single">
                      <div class="category_avatar">
                        <img src="img/category/summer_house.webp" alt="">
                      </div>
                      <div class="category_caption">
    ...
    <section class="stats">
      <div class="section_title">
        <h1>Liczby mówią same za siebie</h1>
      </div>
      <div class="container">
    ...
    <div class="container">
      <div class="autoplay">
        ...
        <!-- Blockquote 1 -->
        <div class="slide">
          <p>Współpracuję z portalem Noclegowo od kilku lat i mam wiele zapytań. Grzeczna obsługa. Jestem osobą w podeszłym wieku często korzystam z pomocy i informacji.</p>
          <span>Villa</span>
        </div>
    ...
    <section class="plan" id="cennik">
      <div class="section_title">
        <h1>Jak mogę rozpocząć współpracę?</h1>
        <p>Współpraca z Noclegowo dostępna jest w jednej z dwóch opcji: <br>
          <span class="font-weight-bold">rozliczenie za rezerwacje</span> lub
          <span class="font-weight-bold">roczna opłata abonamentowa</span>.</p>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-md-9">
        ...
        <div class="row no-align-items responsive">
          ...
          <div class="col-md-12">
            <div class="pricing border_effect text-center">
              ...
              <div class="pricing_button"> <a href="#" class="btn btn-green dimness2 gtm_pricingStandard">Wybieram</a></div>
              <ul>
                ...
                <li id="bolder_standard"><a href="#showmore" data-toggle="collapse" id="#showmore" aria-expanded="false" aria-controls="multiCollapseExample1">Rozwiń pozostałe korzyści
                    <i class="fas fa-angle-down rotate-icon"></i></a></li>
                <div class="collapse multi-collapse" id="showmore">
                  ...
                  <li class=""> Ogłoszenia Szukam noclegu </li>
                </div>
              </ul>
            </div>
          </div>
          <div class="col-md-12">
            <div class="pricing border_effect text-center relative">
              ...
              <div class="pricing_button"> <a href="#" class="btn btn-green dimness2 gtm_pricingPremium">Wybieram</a></div>
              <ul>
                <li> Opłata: 999 zł brutto </li>
                <li> <span class="font-weight-bold">0%</span> prowizji </li>
                <li> <span class="font-weight-bold">99 PKT</span> na pozycjonowanie </li>
                <li id="bolder_premium"><a href="#showmore" data-toggle="collapse" id="#showmore" aria-expanded="false" aria-controls="multiCollapseExample1">Rozwiń pozostałe korzyści
                    <i class="fas fa-angle-down rotate-icon"></i></a></li>
                <div class="collapse multi-collapse" id="showmore">
                  <li> Publikacja przez 12 m-cy </li>
                  <li> Galeria bez limitu </li>
          ...
          <div class="col-md-12">
            <div class="pricing border_effect text-center">
              ...
              <ul>
                ...
                <li id="bolder_max"><a href="#showmore" data-toggle="collapse" id="#showmore" aria-expanded="false" aria-controls="multiCollapseExample1">Rozwiń pozostałe korzyści
                    <i class="fas fa-angle-down rotate-icon"></i></a></li>
                <div class="collapse multi-collapse" id="showmore">
                  <li> Publikacja przez 12 m-cy </li>
                  <li> Galeria bez limitu </li>
          ...
          <div class="col-md-12">
            <div class="pricing border_effect text-center">
              ...
              <div class="pricing_button"><a href="#" class="btn btn-green dimness4 gtm_pricingReservation">Wybieram</a></div>
              <ul>
                <li> Opłata: 0 zł </li>
                <li> <span class="font-weight-bold">8%</span> prowizji </li>
                <li> <span class="font-weight-bold">36 PKT</span> na pozycjonowanie </li>
                <li id="bolder_reserv"><a href="#showmore" data-toggle="collapse" id="#showmore" aria-expanded="false" aria-controls="multiCollapseExample1">Rozwiń pozostałe korzyści
                    <i class="fas fa-angle-down rotate-icon"></i></a></li>
                <div class="collapse multi-collapse" id="showmore">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="alert alert-light text-center mt-4" role="alert">
              <i class="far fa-lightbulb mr-2" style="font-size: 22px"></i> Zarządzasz najmem wielu
              obiektów? <a target="_blank" href="https://www.noclegowo.pl/info/kontakt">Zapytaj o indywidualną ofertę
                współpracy.</a>
            </div>
          </div>
        </div>
        ...
        <div class="panel-group" id="accordion">
          <div class="accordion" id="accordionExample">
            <div class="section_title">
              ...
              <p class="text-muted">Nie zwlekaj ani chwili dłużej. Zacznij pozyskiwać gości już dziś!</p>
            </div>
              ...
              <div class="col-md-6">
                ...
                <div class="faq_item">
                  ...
                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="faq_body">
                      Przy jednorazowej wpłacie goście będą kontaktować się bezpośrednio z Tobą - poprzez numer
                      kontaktowy, formularz e-mail. Natomiast przy rozliczeniu prowizyjnym goście będą mogli przesłać
                      prośbę o rezerwację w konkretnie wskazanym terminie o konkretny rodzaj zakwaterowania. Jeżeli
                      termin będzie dostępny będziesz mógł przyjąć rezerwację, a gość wpłaca zadatek. Cała rezerwacja
                      odbywa się on-line w Noclegowo.
                    </div>
                  </div>
                </div>
                ...
                <div class="faq_item">
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="faq_body">
                      Decydując się na wersję Premium, masz zagwarantowane wyższe pozycje na listach wyszukiwania (m.in.
                      miejscowość, region, rodzaj obiektu). Obiekt znajdzie się wśród obiektów Wyróżnionych. Obiekty
                      Premium zawsze wyświetlane są powyżej obiektów Standard, nawet jeżeli Standard korzysta z
                      dodatkowego pozycjonowania.
                    </div>
                  </div>
                </div>
                ...
                <div class="faq_item">
                  ...
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    <div class="faq_body">
                      Gość zainteresowany Twoim obiektem przesyła prośbę o rezerwację. Wybiera rodzaj zakwaterowania,
                      termin oraz liczbę osób. Natychmiast otrzymasz o tym powiadomienie e-mail oraz sms. Masz 24
                      godziny na potwierdzenie lub odrzucenie takiej prośby. Jeżeli przyjmujesz rezerwację gość ma 24
                      godziny na wpłatę zadatku. Zadatek, pomniejszony o prowizję, przekazywany jest bezpośrednio do
                      Ciebie.
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="faq_item">
                  ...
                  <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                    <div class="faq_body">
                      Nie martw się. System rozliczenia prowizyjnego w Noclegowo jest wyjątkowo prosty. Rezerwacje nie
                      są potwierdzane automatycznie. To Ty decydujesz, która rezerwacja będzie mogła być zrealizowana,
                      poprzez akceptację prośby wysłanej przez gościa.
                    </div>
                  </div>
                </div>
                <!-- question 5 -->
                <div class="faq_item">
                  ...
                  <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                    <div class="faq_body">
                      Obiekt będzie wyświetlany na wszystkich listach zgodny z rodzajem Twojego obiektu oraz
                      lokalizacją. To znaczy, że jeżeli masz domek nad morzem to Twój obiekt będzie widoczny w
                      miejscowości np. Władysławowie, w kryterium domki we Władysławowie, w całym regionie, czyli na
                      Wybrzeżu, nad morzem, w województwie.
                    </div>
                  </div>
                </div>
                ...
                <div class="faq_item">
                  ...
                  <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                    <div class="faq_body">
                      Do Twojej dyspozycji jest Dział Obsługi Klienta Noclegowo. Chętnie odpowiemy na Twoje wszystkie
                      pytania, udzielimy rady i wysłuchamy sugestii dotyczących usprawnień portalu, które według Ciebie
                      byłyby wartościowe. Wystarczy zadzwonić lub skontaktować się mailowo. Jesteśmy tu dla Ciebie!
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section class="knowledge ebook" id="wiedza">
      <div class="section_title">
        <h1>Odbierz darmowy ebook</h1>
      </div>
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-md-5">
            <img src="img/ebook/guide_ebook.webp">
          </div>
          <div class="col-md-5">
            <div class="row">
              <div class="col-md-12">
                <p class="about_title">Dzielimy się wiedzą i doświadczeniem</p>
                <p class="mb-4">Znamy się na tym, co robimy, dlatego stworzyliśmy dla Ciebie źródło praktycznej i
                  kompletnej wiedzy w
                  postaci e-booka. W tym wydaniu dowiesz się m.in: </p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-10">
                <p class="">Jak zachęcić gości do wystawienia opinii, czyli przydatne sposoby, by gość odwiedził Twój
                  obiekt.</p>
              </div>
    ...
    <section class="guide">
      <div class="section_title">
        ...
        <p class="text-muted">Dowiedz się, jak zadbać o reklamę swojego obiektu w internecie.</p>
      </div>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-4">
            <div class="card">
              <div class="card_image">
                <a target="_blank" href="https://www.noclegowo.pl/przewodnik/popraw-skutecznosc-oferty-kompletny-poradnik-od-noclegowo/">
                  <img src="img/guide/effectiveness.webp" alt="Popraw skuteczność oferty - kompletny poradnik od Noclegowo"></a>
              </div>
              <div class="card_body">
                ...
                <p>Co zrobić, aby oferta noclegu przyciągała i była inna niż wszystkie? My znamy odpowiedź i chętnie dzielimy się tą wiedzą.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <div class="card_image">
                <a target="_blank" href="https://www.noclegowo.pl/przewodnik/12-krokow-do-perfekcyjnej-galerii-zdjec/">
                  <img src="img/guide/gallery.webp" alt="12 kroków do perfekcyjnej galerii zdjęć Twojego obiektu"></a>
              </div>
              <div class="card_body">
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card_image">
                <a target="_blank" href="https://www.noclegowo.pl/przewodnik/jak-zachecic-gosci-do-wystawienia-opinii/"><img src="img/guide/home.webp" alt="Jak zachęcić gości do wystawienia opinii?"></a>
              </div>
              <div class="card_body">
                ...
                <p>Na rynku turystycznym miejsc noclegowych przybywa, a wymagania gości rosną. Dowiedz się jak im sprostać. </p>
              </div>
            </div>
          </div>
          <div class="btn-more">
    ...
    <section class="commercial" id="video">
      <div class="section_title">
        <h1>Chcemy być bliżej Ciebie</h1>
      </div>
      <div class="container">
        <div class="row justify-content-around youtube">
          <div class="col-md-5">
            <h1>Oglądaj nas na YouTube</h1>
            <p>Noclegowo.tv to kanał, gdzie doświadczeni właściciele udzielają cennych wskazówek oraz opowiadają ciekawostki,
              które przydarzają im się w biznesie wynajmu krótkoterminowego.</p>
            <p> Dzięki przeprowadzanym przez nas wywiadom, poznajemy lepiej Was i Wasze potrzeby, dzięki czemu stale możemy poprawiać użyteczność portalu. </p>
          </div>
          <div class="col-md-5 col-sm-12 col-xs-12">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe border-bottom: 2px solid #2ecc71;width="653" height="380" src="https://www.youtube.com/embed/videoseries?list=PLR-cdLWSgmoQ27M2LR7vLHDPh29zZYFYz" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
            </div>
          </div>
          <div class="btn-more">
...
<div class="tab-content" id="v-pills-tabContent">
  ...
  <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">...</div>
   ...
   <a id="toggle-imprint" href="#abo">Imprint</a>
    ...
    <section class="general">
      <div class="container">
        <div class="section_title">
          <h1>Gotowy na pozyskiwanie gości?</h1>
          <p class="text-muted">Bo my tak :)</p>
        </div>
        <div class="row">
          <div class="col-md-12 text-center">
            <img src="img/team.webp">
            <!-- <h1 class="rotated_text">Gotowy na pozyskiwanie gości? Bo my tak :)</h1> -->
          </div>
        </div>
        <div class="btn-more">
        ...
        <div class="row no-align-items">
          ...
          <div class="col-md-3">
            ...
            <ul>
              ...
              <li><a target="_blank" href="https://www.noclegowo.pl/przewodnik/kategoria/dla-wlascicieli/">Porady dla
                  wynajmujących</a></li>
      ...
      <div class="footer_copyright">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-8">
              <img src="img/partners/partners.webp">
            </div>
          </div>
        </div>
      </div>
    ...
    <script defer type="text/javascript" src="bootstrap-4.1.3/js/bootstrap.bundle.min.js"></script>
